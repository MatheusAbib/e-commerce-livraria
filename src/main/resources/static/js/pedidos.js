...
//                 <p style="margin-bottom: 10px;">Você tem direito a um cupom de troca (20% do valor do pedido):</p>
...
//   const pedidoId = document.getElementById('pedido-id-devolucao').value;
...
//       throw new Error(error.message || 'Erro ao solicitar devolução');
//     }
...
//       const filtered = pedidosCache.filter(p => p.status === 'DEVOLUCAO');
