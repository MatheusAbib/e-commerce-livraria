...
//             <button onclick="editarEndereco(${enderecoCobranca.id || 'null'}, 'COBRANCA')" class="btn btn-primary btn-sm">Editar</button>
//           </div>
...
//                 </h4>
//                 <div>
//                   <button onclick="editarEndereco(${e.id}, 'ENTREGA')" class="btn btn-primary btn-sm">Editar</button>
//                   <button onclick="confirmarExclusaoEndereco(${e.id})" class="btn btn-danger btn-sm" style="margin-left: 5px;">Excluir</button>
//                 </div>
//               </div>
...
//           <button onclick="adicionarNovoEndereco()" class="btn btn-accent">+ Adicionar Endereço de Entrega</button>
//         </div>
//       `;
...
//                               </div>
//                               <div>
//                                   <button onclick="editarCartao(${index})" class="btn btn-primary btn-sm">Editar</button>
...
//       html += `
//         <div>
//           <button onclick="adicionarNovoCartao()" class="btn btn-accent">+ Adicionar Cartão de Crédito</button>
//         </div>
//       `;
